...
Cost PedestrianCost::EdgeCost(const baldr::DirectedEdge* edge,
  ...
  if (edge->use() == Use::kFootway || edge->use() == Use::kPath || edge->use() == Use::kTrack) {
    ...
    accommodation_factor = 0.7f + use_roads_;
  }
